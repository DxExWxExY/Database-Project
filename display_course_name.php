...
<div id="sidr-container">
            ...
            <div class="container headerContainer">
                ...
                <div class="UTEP-Branding">
                    ...
                    <div class="collegeHeading">
                        <h1 role="banner"><a href="#">Course Name Table</a></h1>
                    </div>
                    <!-- /navbar-header -->
                </div>
                <!-- /UTEP-Branding -->
    ...
    <div class="main-content">
        ...
        if (isset($_SESSION['login_user']) && $_SESSION['login_user'] === 'frontdesk') {
            echo "<form action=\"display_course_name.php\" method=\"post\">
                <p>Course Number: <input type=\"text\" placeholder=\"id\" name=\"cnumber\" value=\"\"></p>
                <p>Course Name: <input type=\"text\" name=\"cname\" value=\"\"></p>
                <input type=\"submit\" >
            </form>";
            ...
            if ($cnumber !== "" && $cname !== "") {
                $sql = "insert into `f19_team5`.`course_name` ( `cnumber`,`cname`) values ('$cnumber','$cname')";
                $result = $conn->query($sql);
            }
            if ($_POST["delete"] !== "") {
                $sql = "delete from f19_team5.course_name where sid = '" . $_POST["delete"] . "'";
                $result = $conn->query($sql);
                $_POST["delete"] = "";
            }
            displayCourseName();
