...
<body>
<a class="sr-only sr-only-focusable" href="#mainContentArea" id="skippy"><span class="container" style="display:block;"><span
...
<div id="sidr-container">
            ...
            <div class="container headerContainer">
                ...
                <div class="UTEP-Branding">
                    ...
                    <div class="collegeHeading">
                        <h1 role="banner"><a href="#">Add user</a></h1>
                    </div>
                    <!-- /navbar-header -->
                </div>
                <!-- /UTEP-Branding -->
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        ...
                        <ul class="nav navbar-nav">
                            <li class="dropdown"><a aria-expanded="false" aria-haspopup="true" class="dropdown-toggle"
                                                    data-toggle="dropdown" href="#" role="button">Tables Drop Down <span
                                            class="caret"></span></a>
                                <div class="ddWrapper">
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="display_student_courses_taking.php">Student Courses Taking</a></li>
                                        <li><a href="display_student_courses_taken.php">Student Courses Taken</a></li>
                                        <li><a href="display_student_courses_retries.php">Student Courses Retries</a>
                                        </li>
                                        <li><a href="display_student_courses_drops.php">Student Courses Drops</a></li>
                        ...
                        <ul class="nav navbar-nav navbar-right">
                            <li class="hidden-below-1365"><a href="#" id="search-trigger"
                                                             title="Search pages and people"><span aria-hidden="true"
                                                                                                   class="glyphiconglyphicon-search"></span></a>
                            </li>
                            <?php
    ...
    <div class="main-content">
        ...
        echo "VALUE " . $_SESSION['login_user'];
        if (isset($_SESSION['login_user']) && $_SESSION['login_user'] === 'frontdesk') {
            echo "
                <form action=\"display_user.php\" method=\"post\">
                    <p>Uemail: <input type=\"text\" placeholder=\"Email\" name=\"uemail\" value=\"\"></p>
                    <p>Student: <input type=\"radio\" name=\"typeuser\" value=\"student\" checked></p>
                    <p>Advisor: <input type=\"radio\" name=\"typeuser\" value=\"advisor\"></p>
                    <p>Front Desk: <input type=\"radio\" name=\"typeuser\" value=\"fdesk\"></p>
                    <input type=\"submit\" >
                </form>
                ";
            $typeuser = $conn->real_escape_string($_POST['typeuser']);
            $email = $conn->real_escape_string($_POST['uemail']);
            if ($email != "" && $typeuser == 'student') {
                $sql = "insert into `f19_team5`.`user` (`uemail`, `ustudent`, `ufront_desk`, `uadvisor`) values ('$email','1', '0', '0')";
                $result = $conn->query($sql);
            }
            if ($email != "" && $typeuser == 'advisor') {
                $sql = "insert into `f19_team5`.`user` (`uemail`, `ustudent`, `ufront_desk`, `uadvisor`) values ('$email','0', '0', '1')";
                $result = $conn->query($sql);
            }
            if ($email != "" && $typeuser == 'fdesk') {
                $sql = "insert into `f19_team5`.`user` (`uemail`, `ustudent`, `ufront_desk`, `uadvisor`) values ('$email','0', '0', '1')";
                $result = $conn->query($sql);
            }
            if ($_POST["delete"] !== "") {
                $sql = "delete from f19_team5.user where uemail = '" . $_POST["delete"] . "'";
                $result = $conn->query($sql);
                $_POST["delete"] = "";
            }
            displayUser();
        } else {
            echo "<p>Access Denied, admin will be notified.</p>";
        }
        ?>
        <!-- /#container -->
        <footer>
